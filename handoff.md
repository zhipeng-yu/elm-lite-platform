...
| 日期 | 用途 | 涉及文件 | 人工复核人 |
| --- | --- | --- | --- |
| 2026-09-08 | 修复 Windows PowerShell 5.1 将 Maven/MySQL 重定向警告误判为终止错误，保留退出码失败检查；实际启动至 Demo ready，首页 HTTP 200、30 店接口通过，按 Enter 正常停止；后端 verify 成功 | `scripts/start-demo.ps1`、`handoff.md` | 待余复核；已验证警告加退出码 0/7 的处理，未修改业务代码 |
