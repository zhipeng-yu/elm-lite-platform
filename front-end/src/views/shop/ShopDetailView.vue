...
import CustomerCouponPanel from './CustomerCouponPanel.vue'
...
async function load() {
  ...
  try {
    shop.value =
      await fetchShop(route.params.id)
  } catch (error) {
    shop.value = null
