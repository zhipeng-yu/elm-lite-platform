...
public class MerchantShopController {
    ...
    @GetMapping
    public ApiResponse<List<ShopResponse>> list(@AuthenticationPrincipal Jwt jwt) {
        return ApiResponse.success(merchantShopService.list(Long.parseLong(jwt.getSubject())).stream()
                .map(ShopResponse::from).toList());
    }
